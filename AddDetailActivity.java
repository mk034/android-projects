...
public class AddDetailActivity extends AppCompatActivity {
    ...
    private TextView tvItemName, tvQuantityLabel, quantityText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvQuantityLabel = findViewById(R.id.tv_quantityLabel);
        ...
        // 수량 증가 버튼 - 결과를 quantityText에 업데이트함
        ...
        btnIngredientAdd.setOnClickListener(v -> {
            ...
            Toast.makeText(this, ingredientName + " 추가됨, 수량: " + quantity +
                    ", 유통기한: " + expirationDate, Toast.LENGTH_SHORT).show();
        });
    }
